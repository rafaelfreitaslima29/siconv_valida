...
from db.repositories.tb_ajustes_tabela_repository import TbAjustesTabelaRepository
from services.ajustes_table_service import AjustesTabelaService



class ExpAjustesTabelaLLama_3_1_8b_service():
    def __init__(self):
        # TO-DO - Configurando
...
CREATE TABLE pcr_siconv.tb_convenios (
	...
	dias_clausula_suspensiva int4 NULL
        ...
        """
        self._llm_model_name = "llama3.1:8b"
    ...
    def run(self):
        ...
        repository = TbAjustesTabelaRepository()
